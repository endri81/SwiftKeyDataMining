...
```{r, distributions}
# Plot distributions
ggplot(words_from_text, aes(n/sum, fill = id)) +
...
Let's continue our analysis by splitting text in groups containing two or more words (bigrams and trigrams). We will use function **NGramTokenizer** from library **RWeka** library
